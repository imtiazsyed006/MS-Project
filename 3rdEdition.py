'''This is a Graphical User Interface developed for Remotely Operated Vehicle of FME.
This GUI displays real-time plots and displays values on labels as well. 
'''
