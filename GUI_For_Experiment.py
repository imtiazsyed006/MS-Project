...
###################Plots customization go here#########################
        ...
        self.widget_18.setTitle('Time vs Distance')
...
#         self.plot_9 = self.widget_17.plot(self.t,self.Distance,pen=pen)
#         
...
###################################################################################################
    ...
    def getValues(self):
        ...
        if self.Lstartbutton:
            if len(self.firstRun) <= self.DataPoints:
                ...
                xi,yi,zi,xii,yii = gyro2.printHeadings()
    ...
    def UpdatePlot_2(self):
        if self.Lstartbutton:
            ...
            #self.plot_9.setData(self.t,self.Distance)
